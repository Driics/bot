...
package com.sable.changelog;

import com.sable.Sable;
import com.sable.contracts.changelog.ChangelogLoader;
...
public class ChangelogHandler {
    ...
    public synchronized static void loadAndGetMessages(Sable avaire, ChangelogLoader loader) {
        if (!messages.isEmpty()) {
            loader.handle(sortAndFormatMessages(messages.values()));
            return;
        }

        TextChannel changelogChannel = Sable.getInstance().getShardManager().getTextChannelById(
