...
package com.sable.ai.dialogflow;
...
import com.sable.contracts.ai.IntelligenceService;
...
public class DialogFlowService implements IntelligenceService {
    ...
    @Override
    public void registerService(Sable avaire) {
    ...
    @Override
    public void unregisterService(Sable avaire) {
        if (executor != null) {
