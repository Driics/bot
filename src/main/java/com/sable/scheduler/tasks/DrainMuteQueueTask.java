...
import com.sable.mute.MuteContainer;
...
public class DrainMuteQueueTask implements Task {
    ...
    private void handleAutomaticUnmute(Sable avaire, MuteContainer container) {
        try {
    ...
    private void unregisterDatabaseRecord(Sable avaire, MuteContainer container) {
        try {
