...
import com.sable.commands.administration.ModlogReasonCommand;
...
import com.sable.handlers.events.ModlogActionEvent;
...
public class Modlog {
     ...
     */
    @Nullable
    public static String log(Sable avaire, CommandMessage context, ModlogAction action) {
     ...
     */
    @Nullable
    public static String log(Sable avaire, Message message, ModlogAction action) {
     ...
     */
    @Nullable
    public static String log(Sable avaire, Guild guild, ModlogAction action) {
     ...
     */
    @Nullable
    public static String log(Sable avaire, Guild guild, GuildTransformer transformer, ModlogAction action) {
    ...
    private static void logActionToTheDatabase(Sable avaire, Guild guild, ModlogAction action, Message message, int modlogCase) {
        try {
