...
package com.sable.commands.help;

import com.sable.Sable;
import com.sable.admin.AdminUser;
import com.sable.chat.MessageType;
import com.sable.chat.PlaceholderMessage;
import com.sable.commands.*;
...
public class HelpCommand extends Command {
    ...
    public HelpCommand(Sable avaire) {
        super(avaire);
    }
    ...
    public String getDescription() {
        return "Tells you about what commands Sable has, what they do, and how you can use them.";
    }
