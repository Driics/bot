...
public class SoundcloudCommand extends Command {
    ...
    public SoundcloudCommand(Sable avaire) {
        super(avaire, false);
    }
    ...
    public String getDescription() {
        return "Plays the provided song for you, if just the song title is given the sable will search SoundCloud for your song and give you some suggestions, you can also use YouTube, SoundCloud, TwitchTV, Bandcamp, and Vimeo link, or raw sound file, mp3, flac, wav, webm, mp4, ogg, aac, m3u and pls formats.";
    }
