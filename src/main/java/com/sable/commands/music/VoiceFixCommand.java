...
import com.sable.contracts.commands.CommandContext;
...
public class VoiceFixCommand extends Command {
    ...
    public VoiceFixCommand(Sable avaire) {
        super(avaire, false);
    }
    ...
    public String getDescription(@Nullable CommandContext context) {
        ...
        return String.format(String.join(" ",
            ...
            "to do by forcing a voice update state for the sable through changing the server",
            ...
            "If you're still experiencing voice issues you can try making the sable leave the voice",
            ...
            "to get help from the Sable support team directly."
        ), "%", prefix);
    }
    ...
    public List<String> getMiddleware() {
        return Arrays.asList(
            ...
            "require:sable,general.manage_server",
            "musicChannel"
        );
    }
    ...
    private void logError(CommandMessage context, Throwable exception) {
        ...
        Sable.getLogger().error("An error was thrown in the Voice Fix command while trying to change the server region: "
