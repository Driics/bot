...
package com.sable.commands;

import com.sable.Sable;
import com.sable.Constants;
import com.sable.commands.system.JSONCmdMapCommand;
import com.sable.contracts.commands.Command;
import com.sable.contracts.commands.CommandSource;
import com.sable.database.controllers.GuildController;
import com.sable.database.transformers.GuildTransformer;
import com.sable.exceptions.InvalidCommandPrefixException;
import com.sable.exceptions.MissingCommandDescriptionException;
...
public class CommandHandler {
     ...
     */
    public static CommandContainer getCommand(Sable avaire, Message message, @Nonnull String command) {
     ...
     */
    public static CommandContainer getCommandByAlias(Sable avaire, Message message, @Nonnull String command) {
    ...
    private static boolean hasImplementedADescriptionMethod(Command command) {
        try {
            Sable.getLogger().info("{} called hasImplementedADescriptionMethod::withArgs", command.getClass().getTypeName());
        ...
        try {
            Sable.getLogger().info("{} called hasImplementedADescriptionMethod::noArgs", command.getClass().getTypeName());
