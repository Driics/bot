...
public class SayCommand extends Command {
    ...
    public SayCommand(Sable avaire) {
        super(avaire);
    }
    ...
    public String getDescription() {
        return "The sable will repeat anything you tell it to, if a channel is mentioned, the message will be sent in that channel instead.";
    }

    @Override
    public List<String> getUsageInstructions() {
        return Arrays.asList(
            "`:command <message>` - Makes the sable say the given message in the current channel.",
            "`:command <channel> <message>` - Makes the sable say the given message in the channel."
        );
    }
    ...
    public List<String> getExampleUsage() {
        return Arrays.asList(
            "`:command I am a BOT` - Makes the sable send the \"I am a sable\" message.",
            "`:command #general Hi there!` - Makes the sable send the message in #general."
        );
    }
    ...
    public boolean onCommand(CommandMessage context, String[] args) {
        ...
        context.delete().reason("Sable say command usage").queue(null, RestActionUtil.ignore);
