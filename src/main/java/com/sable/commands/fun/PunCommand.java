...
import com.sable.requests.Request;
import com.sable.requests.Response;
import com.sable.requests.service.PunService;
...
public class PunCommand extends Command {
    ...
    public PunCommand(Sable avaire) {
        super(avaire);
    }
    ...
    private Request makeRequest(CommandMessage context, boolean withSearch) {
        return RequestFactory.makeGET("https://icanhazdadjoke.com/" + (withSearch ? "search" : ""))
            ...
            .addHeader("User-Agent", String.format("Sable Bot (ID:%s, GitHub:https://github.com/avaire/avaire)",
