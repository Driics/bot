...
import com.sable.contracts.commands.CacheFingerprint;
...
public class RemoveSelfAssignableRoleCommand extends Command {
    ...
    public RemoveSelfAssignableRoleCommand(Sable avaire) {
        super(avaire, false);
    }
    ...
    public boolean onCommand(CommandMessage context, String[] args) {
        ...
        try {
            ...
            avaire.getDatabase().newQueryBuilder(Constants.GUILD_TABLE_NAME)
                ...
                .update(statement -> {
                    statement.set("claimable_roles", Sable.gson.toJson(transformer.getSelfAssignableRoles()));
                });
