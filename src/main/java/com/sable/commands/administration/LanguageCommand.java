...
package com.sable.commands.administration;
...
public class LanguageCommand extends Command {
    ...
    public LanguageCommand(Sable avaire) {
        super(avaire, false);
    }
    ...
    public String getDescription() {
        return "Show a list of available languages or set a language that should be used for the server.\n" +
            "If you are interested in contributing to the translations of Sable, then head on over to [translate.avairebot.com](https://translate.avairebot.com/)!";
    }
    ...
    public List<String> getExampleUsage() {
        return Arrays.asList(
            ...
            "`:command english` - Changes the language of the sable to English"
        );
    }
    ...
    public boolean onCommand(CommandMessage context, String[] args) {
        ...
        try {
            ...
            Sable.getLogger().error("Failed to update the language for a server({}), error: " + e.getMessage(),
                context.getGuild().getId()
            );
            return sendErrorMessage(context, "Failed to update the servers language settings, please try again, if this problem persists, please contact one of the sable developers about it.");
        }
