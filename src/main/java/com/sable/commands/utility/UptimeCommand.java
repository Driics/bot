...
public class UptimeCommand extends Command {
    ...
    public UptimeCommand(Sable avaire) {
        super(avaire);
    }
    ...
    public String getDescription() {
        return "Displays how long the sable has been online for.";
    }

    @Override
    public List<String> getUsageInstructions() {
        return Collections.singletonList("`:command` - Displays how long the sable has been online for.");
    }
