...
import com.sable.changelog.ChangelogHandler;
import com.sable.changelog.ChangelogMessage;
...
public class ChangelogCommand extends Command {
    ...
    public ChangelogCommand(Sable avaire) {
        super(avaire, false);
    }
    ...
    public String getDescription() {
        return "Displays a log of changes made to the sable between different versions, versions can be listed by themselves, and changes for the given versions can be looked up through this command, allowing users to see what happened, and when it happened.";
    }
