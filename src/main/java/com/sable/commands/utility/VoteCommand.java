...
import com.sable.vote.VoteEntity;
...
public class VoteCommand extends Command {
    ...
    public VoteCommand(Sable avaire) {
        super(avaire);
    }
    ...
    public String getDescription() {
        return "Enjoy using the sable? Consider voting for the sable to help it grow, it's free but means a lot to the team behind Ava <3";
    }
    ...
    public boolean onCommand(CommandMessage context, String[] args) {
        ...
        context.makeSuccess(String.join("\n", Arrays.asList(
            "Enjoy using the sable? Consider voting for the sable to help it grow, it's free but means a lot to the team behind Ava ❤",
            "",
            ...
            .set("note", note)
            .setTitle("Vote for Sable on DBL", "https://discordbots.org/bot/avaire")
