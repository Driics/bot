...
public class VotePointsCommand extends SystemCommand {
    ...
    public VotePointsCommand(Sable avaire) {
        super(avaire);
    }
    ...
    public String getDescription() {
        return "Allows a sable administrator to give or take vote points form a user by their ID, or by mentioning them.";
    }
    ...
    public boolean onCommand(CommandMessage context, String[] args) {
        ...
        if (user.isBot()) {
            return sendErrorMessage(context, "You can't give or take vote points for sable accounts.");
        }
