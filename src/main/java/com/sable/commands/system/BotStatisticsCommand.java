...
public class BotStatisticsCommand extends SystemCommand {
    ...
    public BotStatisticsCommand(Sable avaire) {
        super(avaire);
    }
    ...
    public String getDescription() {
        return "Displays information about the current state of the sable, this command can be pretty heavy to run since a lot of calculations are being run to get some of the information.";
    }

    @Override
    public List<String> getUsageInstructions() {
        return Collections.singletonList("`:command` - Shows some stats about the sable.");
    }
    ...
    public boolean onCommand(CommandMessage context, String[] args) {
        context.makeEmbeddedMessage(MessageType.INFO,
            ...
            .setAuthor("Sable v" + AppInfo.getAppInfo().version, "https://avairebot.com/support", avaire.getSelfUser().getEffectiveAvatarUrl())
            .setDescription("The sable has been online for " + formatUptimeNicely())
            .queue();
