...
import com.sable.database.migrate.migrations.CreateGuildTypeTableMigration;
...
public class ResetStatusTypesCommand extends SystemCommand {
    ...
    public ResetStatusTypesCommand(Sable avaire) {
        super(avaire);
    }
    ...
    public String getDescription() {
        return "Resets the status types in the database, this is useful overwriting the server status types limits to get new features after updating the sable, or to simply reset back to the default if it breaks after editing it with custom changes.";
    }
