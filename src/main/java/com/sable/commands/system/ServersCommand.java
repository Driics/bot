...
import com.sable.contracts.commands.sort.ServerComparable;
...
public class ServersCommand extends SystemCommand {
    ...
    public ServersCommand(Sable avaire) {
        super(avaire);
    }
    ...
    public String getDescription() {
        return "Lists servers the sable is in with some basic information about them, allowing admins to list servers using different filters.";
    }
    ...
    enum SortTypes {
        ...
        BOTS(
            ...
            "Orders servers by sable count, this doesn't include bots in the server.",
            "bots", "sable"
        ),
        USERS(
