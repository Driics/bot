...
public class UninstallPlugin extends PluginSubCommand {
     ...
     */
    public UninstallPlugin(Sable avaire, PluginCommand command) {
    ...
    public boolean onCommand(CommandMessage context, String[] args) {
        ...
        context.makeSuccess("The **:name** plugin have successfully been uninstalled, however the sable may need to restart before all the features associated with the :name plugin is removed.")
