...
import com.sable.commands.system.plugin.InstallPlugin;
import com.sable.commands.system.plugin.ListPlugins;
import com.sable.commands.system.plugin.ShowPlugin;
import com.sable.commands.system.plugin.UninstallPlugin;
...
public class PluginCommand extends SystemCommand {
    ...
    public PluginCommand(Sable avaire) {
        super(avaire);
    ...
    public String getDescription() {
        return "Can be used to list installed plugins, as well as available plugins that are officially recognized by the Sable development team, you can also display more information about a specific plugin by name.";
    }
