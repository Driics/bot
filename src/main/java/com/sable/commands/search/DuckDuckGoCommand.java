...
package com.sable.commands.search;
...
public class DuckDuckGoCommand extends Command {
    ...
    public DuckDuckGoCommand(Sable avaire) {
        super(avaire);
    }
    ...
    public List<String> getExampleUsage() {
        return Collections.singletonList("`:command Sable Bot`");
    }
    ...
    public boolean onCommand(CommandMessage context, String[] args) {
        ...
        try {
            ...
            headers.put("User-Agent", "Sable-Discord-Bot (" + avaire.getSelfUser().getId() + ")");
            ...
            e.printStackTrace();
            Sable.getLogger().error("Failed to complete search query: ", e);
        }
        return false;
    }
