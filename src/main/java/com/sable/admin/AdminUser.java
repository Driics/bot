...
public class AdminUser {
    ...
    /**
     * Checks if the admin user is a sable admin globally, this is only true if
     * the user has their ID stored in the sable access field in the config.
     *
     * @return {@code True} if the user is a sable admin globally, {@code False} otherwise.
     */
     ...
     * has the special sable admin role on the official support server.
     *
     * @return {@code True} if the user is a sable role admin, {@code False} otherwise.
     */
    ...
    /**
     * Checks if the admin user is actually a sable admin by checking if {@link #isGlobalAdmin()}
     * or {@link #isRoleAdmin()} returns {@code True}.
     *
     * @return {@code True} if the user is a sable admin, {@code False} otherwise.
     */
