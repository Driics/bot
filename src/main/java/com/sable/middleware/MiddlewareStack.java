...
import com.sable.middleware.global.IncrementMetricsForCommand;
import com.sable.middleware.global.IsCategoryEnabled;
import com.sable.middleware.global.ProcessCommand;
...
public class MiddlewareStack {
     ...
     */
    static void buildGlobalMiddlewares(Sable avaire) {
    ...
    /**
     * Returns <code>True</code> if the command was invoked through mentioning the sable first.
     *
     * @return <code>True</code> if the command was invoked through mentioning the sable first.
     */
