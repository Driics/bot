...
import com.sable.commands.AliasCommandContainer;
...
import com.sable.utilities.CheckPermissionUtil;
...
public class ProcessCommand extends Middleware {
    ...
    public ProcessCommand(Sable avaire) {
        super(avaire);
    }
    ...
    public boolean handle(@Nonnull Message message, @Nonnull MiddlewareStack stack, String... args) {
        ...
        Sable.getLogger().info(commandOutput
