...
package com.sable.middleware.global;

import com.sable.Sable;
import com.sable.commands.Category;
import com.sable.commands.CommandHandler;
import com.sable.commands.administration.ToggleCategoryCommand;
...
public class IsCategoryEnabled extends Middleware {
    ...
    public IsCategoryEnabled(Sable avaire) {
        super(avaire);
    }
    ...
    public boolean handle(@Nonnull Message message, @Nonnull MiddlewareStack stack, String... args) {
        if (disabledCategories.containsKey(stack.getCommandContainer().getCategory().getName())) {
            ...
            if (disabledMessage == null) {
                disabledMessage = "The :category command category is currently disable globally by a sable administrator.";
            }
    ...
    private boolean isCategoryCommands(MiddlewareStack stack) {
        return stack.getCommand().getClass().getTypeName().equals("ToggleCategoryCommand") ||
            stack.getCommand().getClass().getTypeName().equals("CategoriesCommand");
    }

    private boolean isHelpCommand(MiddlewareStack stack) {
        return stack.getCommand().getClass().getTypeName().equals("HelpCommand");
    }
}
