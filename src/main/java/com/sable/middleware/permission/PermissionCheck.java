...
package com.sable.middleware.permission;
...
public class PermissionCheck {
    ...
    /**
     * A list of permissions that are missing for the sable.
     */
    ...
    /**
     * Determines if the sable has at least one of the required permissions.
     */
     ...
     * A list of permissions that are missing for the sable.
     *
     * @return A list of permission missing for the sable.
     */
    ...
    /**
     * Returns true if the sable has at least one of the required permissions.
     *
     * @return <code>True</code> if the sable has at least one of the required permissions, <code>False</code> otherwise.
     */
    ...
    /**
     * Checks if the {@link #missingBotPermissions missing sable permissions}, and the
     * {@link #missingUserPermissions missing user permissions} list are both empty.
     *
     * @return Checks if sable the user and sable permissions list are empty.
     */
