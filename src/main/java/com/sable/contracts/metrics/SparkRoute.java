...
package com.sable.contracts.metrics;
...
public abstract class SparkRoute implements Route {
    ...
    protected String getAuthorizationToken() {
        return Sable.getInstance().getConfig().getString("web-servlet.authToken",
            Sable.getInstance().getConfig().getString("metrics.authToken", "sable-auth-token")
        );
    }
}
