...
package com.sable.contracts.audio;
...
import com.sable.contracts.debug.EvalAudioEventWrapper;
...
public abstract class AudioEventWrapper extends EvalAudioEventWrapper {
     ...
     * request music through the sable, it the main source for
     * handling everything related to music in the sable.
     */
