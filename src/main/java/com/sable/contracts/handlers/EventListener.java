...
import com.sable.handlers.events.MusicEndedEvent;
import com.sable.handlers.events.NowPlayingEvent;
...
public abstract class EventListener extends ListenerAdapter implements net.dv8tion.jda.api.hooks.EventListener {
     ...
     * the application shuts down, the event will be invoked when a sable
     ...
     * the sable starts playing a new song, the guild the song is
     ...
     * the sable leaves the voice channel when the music has ended, this
