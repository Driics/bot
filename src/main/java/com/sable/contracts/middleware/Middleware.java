...
package com.sable.contracts.middleware;
...
public abstract class Middleware {
     ...
     *
     * @see Metrics#setup(Sable) Metrics setup.
     */
    ...
    /**
     * Instantiates the middleware and sets the sable class instance.
     *
     * @param avaire The Sable application class instance.
     */
    public Middleware(Sable avaire) {
        this.avaire = avaire;
    }

    /**
     * Instantiates the middleware and sets the sable class instance through the plugin instance.
     *
     * @param plugin The Sable application class instance.
     */
