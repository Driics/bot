...
public abstract class SystemCommand extends Command {
    ...
    /**
     * Creates the given command instance by calling {@link #SystemCommand(Sable, boolean)} with allowDM set to true.
     *
     * @param avaire The Sable class instance.
     */
    public SystemCommand(Sable avaire) {
        this(avaire, true);
    }
     ...
     */
    public SystemCommand(Sable avaire, boolean allowDM) {
