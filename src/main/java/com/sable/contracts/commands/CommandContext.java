...
public interface CommandContext {
     ...
     * <p>
     * This is just a shortcut for calling {@link #getDatabaseEventHolder()}{@link DatabaseEventHolder#getPlayer()},
     * but if that returns null, then {@link PlayerController#fetchPlayer(Sable, Message)}
     * will automatically be called instead.
     *
     * @param avaire The main Sable instance used to communicate with the rest of the application.
     ...
     */
    @Nullable
    default PlayerTransformer getPlayerTransformerWithForce(@Nonnull Sable avaire) {
     ...
     * <br>If no user was mentioned, this list is empty, if the sable was mentioned as part of
     * invoking the command, the {@link #isMentionableCommand() isMentionableCommand()}
     * should be true, and the sable will be stripped from the mentioned users list.
     *
     ...
     * that the command was invoked by mentioning the sable instead of using the
    ...
    /**
     * Returns the {@link YamlConfiguration configuration} for the current selected {@link I18n I18n}
     * language, if the message was sent as a direct message, or if the guild doesn't have a valid language
     * selected the {@link I18n#defaultLanguage default language} will be used instead.
     *
     * @return The selected {@link YamlConfiguration configuration} for the current messages {@link I18n I18n} language.
     */
    @Nonnull
    YamlConfiguration getI18n();

    /**
     * Gets a string from the {@link I18n I18n} language file with the
     ...
     * </code></pre>
     *
     * @param key The key of the {@link I18n I18n} message.
    ...
    /**
     * Gets a raw string from the {@link I18n I18n} language file, this will ignore the command
    ...
    /**
     * Gets the {@link I18n I18n} command prefix.
     *
     * @return The {@link I18n I18n} command prefix.
     */
    String getI18nCommandPrefix();

    /**
     * Generates the new {@link I18n I18n} command prefix off the {@link CommandContainer Command Container}, then calls {@link #setI18nPrefix(String)} with the generated message, command prefixes are generated using the following format:
     * <br>
     * <pre><code>
     ...
     * </code></pre>
     *
     * @param container The {@link CommandContainer Command Container} to use for generating the {@link I18n I18n} prefix.
     */
    void setI18nCommandPrefix(@Nonnull CommandContainer container);

    /**
     * Sts the {@link I18n I18n} command prefix to the given string.
     *
     * @param i18nPrefix The string the {@link I18n I18n} prefix should be set to.
     */
