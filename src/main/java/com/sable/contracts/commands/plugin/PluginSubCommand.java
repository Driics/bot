...
package com.sable.contracts.commands.plugin;
...
public abstract class PluginSubCommand {
     ...
     */
    public PluginSubCommand(Sable avaire, PluginCommand command) {
        this.avaire = avaire;
     ...
     * associated with the downloaded file, allowing the sable
