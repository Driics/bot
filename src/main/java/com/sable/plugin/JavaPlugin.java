...
import com.sable.config.Configuration;
...
import com.sable.database.migrate.Migrations;
import com.sable.exceptions.InvalidConfigurationException;
import com.sable.language.I18n;
import com.sable.language.Language;
import com.sable.language.LanguageContainer;
import com.sable.middleware.MiddlewareHandler;
...
public abstract class JavaPlugin {
    ...
    private Sable avaire;
    private PluginLoader loader;

    private Configuration config = null;

    /**
     * Initializes the plugin by setting the global sable
     * application instance and preparing some data.
     *
     * @param avaire The global sable application instance.
     */
    final void init(Sable avaire, PluginLoader loader) {
        this.avaire = avaire;
        this.loader = loader;
     ...
     * <p>
     * All migrations must follow the {@link Migration Migration contract}.
     *
    ...
    /**
     * Returns the global Sable application instance.
     *
     * @return The global Sable application instance.
     */
    public final Sable getAvaire() {
        return avaire;
    }

    /**
     * Gets the shard manager used by the sable, giving you access to methods
     * that can interact with the application on a global scale.
     *
     * @return A list of sable shard entries.
     */
