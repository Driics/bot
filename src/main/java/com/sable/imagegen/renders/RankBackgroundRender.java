...
package com.sable.imagegen.renders;

import com.sable.contracts.imagegen.Renderer;
import com.sable.imagegen.Fonts;
...
public class RankBackgroundRender extends Renderer {
    ...
    protected BufferedImage handleRender() throws IOException {
        ...
        urlConnection.setRequestProperty("User-Agent", "Sable-Discord-Bot");
