...
package com.sable.metrics;

import ch.qos.logback.classic.LoggerContext;
import com.sable.Sable;
import com.sable.blacklist.Ratelimit;
import com.sable.commands.Category;
import com.sable.commands.administration.MuteRoleCommand;
import com.sable.commands.utility.GlobalLeaderboardCommand;
import com.sable.commands.utility.LeaderboardCommand;
...
import com.sable.database.controllers.*;
import com.sable.handlers.adapter.JDAStateEventAdapter;
import com.sable.level.LevelManager;
import com.sable.metrics.routes.GetMetrics;
import com.sable.middleware.ThrottleMiddleware;
import com.sable.scheduler.jobs.LavalinkGarbageNodeCollectorJob;
...
public class Metrics {
    ...
    public static void setup(Sable avaire) {
        if (isSetup) {
