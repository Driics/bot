...
import com.sable.audio.source.PlaylistImportSourceManager;
...
public class AudioPlayerManagerConfiguration implements Supplier<AudioPlayerManager> {
     ...
     */
    public AudioPlayerManagerConfiguration(Sable avaire) {
     ...
     */
    public AudioPlayerManagerConfiguration(Sable avaire, AudioPlayerManager audioPlayerManager) {
        this.avaire = avaire;
