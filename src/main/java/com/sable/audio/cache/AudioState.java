...
public class AudioState extends Evalable implements Serializable {
     ...
     * tracks in the queue, the audio state can be used when the sable shuts
     * down, to save it all the cache, or when the sable starts back up
    ...
    /**
     * Gets the audio track that was playing at the time that the sable shut down.
     *
     * @return The audio track that was playing when the sable shut down.
     */
    @Nullable
    ...
    /**
     * The volume the music was playing at when the sable shut down.
     *
     * @return The volume the music was playing at when the sable shut down.
     */
