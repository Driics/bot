...
package com.sable.audio.searcher;

import com.sable.audio.AudioHandler;
import com.sable.audio.TrackRequestContext;
import com.sable.audio.exceptions.Http503Exception;
import com.sable.audio.exceptions.InvalidSearchProviderException;
import com.sable.audio.exceptions.SearchingException;
import com.sable.audio.exceptions.TrackLoadFailedException;
import com.sable.database.controllers.SearchController;
...
public class SearchTrackResultHandler implements AudioLoadResultHandler {
     ...
     * YouTube is currently rate limiting the sable.
     */
