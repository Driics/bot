...
public class LavalinkManager {
     ...
     */
    public void start(Sable avaire) {
     ...
     *
     * @param channel The voice channel that the sable should be connecting to.
     */
     ...
     *
     * @param guild The guild that the sable should close the connection for.
     */
     ...
     * @return Possibly-null, The VoiceChannel that the sable is connected to.
     */
    @Nullable
