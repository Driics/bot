...
public class Main {
    ...
    public static void main(String[] args) throws IOException, SQLException, InvalidApplicationEnvironmentException {
        ...
        options.addOption(new Option("sc", "shard-count", true, "Sets the amount of shards the sable should start up."));
        ...
        options.addOption(new Option("gsf", "generate-json-file", false, "Enters command generation mode, when this flag is enabled, the sable won't actually start, but will instead generate a \"commandMap.json\" file containing information about all the registered commands. This file is used for avairebot.com to generate the commands page."));
        ...
        try {
            ...
            if (cmd.hasOption("help")) {
                ...
                System.out.println(Sable.getVersionInfo(settings));
                System.exit(ExitCodes.EXIT_CODE_NORMAL);
            }

            Sable.avaire = new Sable(settings);
