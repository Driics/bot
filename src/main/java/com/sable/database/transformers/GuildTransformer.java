...
import com.sable.audio.DJGuildLevel;
...
public class GuildTransformer extends Transformer {
    ...
    public GuildTransformer(Guild guild, DataRow data) {
        ...
        if (hasData()) {
            ...
            if (data.getString("aliases", null) != null) {
                HashMap<String, String> dbAliases = Sable.gson.fromJson(
            ...
            if (data.getString("prefixes", null) != null) {
                HashMap<String, String> dbPrefixes = Sable.gson.fromJson(
            ...
            if (data.getString("claimable_roles", null) != null) {
                HashMap<String, String> dbSelfAssignableRoles = Sable.gson.fromJson(
            ...
            if (data.getString("level_roles", null) != null) {
                HashMap<String, String> dbLevelRoles = Sable.gson.fromJson(
            ...
            if (data.getString("level_exempt_channels", null) != null) {
                List<String> dbExemptExperienceChannels = Sable.gson.fromJson(
            ...
            if (data.getString("modules", null) != null) {
                HashMap<String, Map<String, String>> dbModules = Sable.gson.fromJson(
            ...
            if (data.getString("channels", null) != null) {
                HashMap<String, Object> dbChannels = Sable.gson.fromJson(
    ...
    public String channelsToJson() {
        ...
        return Sable.gson.toJson(objects);
    }
}
