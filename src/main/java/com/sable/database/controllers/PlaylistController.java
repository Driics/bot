...
public class PlaylistController {
    ...
    @CheckReturnValue
    public static Collection fetchPlaylists(Sable avaire, Message message) {
    ...
    @CheckReturnValue
    public static PlaylistTransformer fetchPlaylistFromName(Sable avaire, Message message, String name) {
