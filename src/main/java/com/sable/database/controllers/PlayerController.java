...
import com.sable.level.ExperienceEntity;
...
public class PlayerController {
    ...
    @CheckReturnValue
    public static PlayerTransformer fetchPlayer(Sable avaire, Message message) {
        return fetchPlayer(avaire, message, message.getAuthor());
    }

    @CheckReturnValue
    public static PlayerTransformer fetchPlayer(Sable avaire, Message message, User user) {
    ...
    private static PlayerTransformer mergeWithExperienceEntity(Sable avaire, PlayerTransformer transformer) {
