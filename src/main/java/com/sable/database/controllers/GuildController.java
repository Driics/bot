...
public class GuildController {
     ...
     *
     * @param avaire  The sable instance, used to talking to the database.
     ...
     */
    @CheckReturnValue
    public static GuildTransformer fetchGuild(Sable avaire, Message message) {
     ...
     */
    @CheckReturnValue
    public static GuildTransformer fetchGuild(Sable avaire, Guild guild) {
    ...
    public static String buildChannelData(List<TextChannel> textChannels) {
        ...
        return Sable.gson.toJson(channels);
    }
    ...
    public static String buildRoleData(List<Role> roles) {
        ...
        return Sable.gson.toJson(rolesMap);
    }
    ...
    private static GuildTransformer loadGuildFromDatabase(Sable avaire, Guild guild) {
    ...
    private static void updateGuildEntry(Sable avaire, Guild guild, Member owner) {
        try {
            ...
            Sable.getLogger().error(ex.getMessage(), ex);
        }
    }
}
