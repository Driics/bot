...
import com.sable.database.transformers.ReactionTransformer;
...
public class ReactionController {
     ...
     */
    @CheckReturnValue
    public static Collection fetchReactions(Sable avaire, Message message) {
     ...
     */
    @CheckReturnValue
    public static Collection fetchReactions(@Nonnull Sable avaire, @Nullable Guild guild) {
        if (guild == null) {
            return null;
        }
     ...
     */
    @CheckReturnValue
    public static ReactionTransformer fetchReactionFromMessage(Sable avaire, Message message) {
