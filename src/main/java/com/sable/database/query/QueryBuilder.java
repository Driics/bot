...
package com.sable.database.query;

import com.sable.contracts.database.Database;
import com.sable.contracts.database.QueryClause;
import com.sable.contracts.database.query.ChangeableClosure;
import com.sable.contracts.database.query.ClauseConsumer;
...
public final class QueryBuilder {
     ...
     */
    private Database.QueryType type;
    ...
    public QueryBuilder select(String... columns) {
        type = Database.QueryType.SELECT;
     ...
     * or (2) <code>NULL</code> if an error occurred.
     */
    public String toSQL(Database.QueryType type) {
        try {
            switch (type) {
                case SELECT:
     ...
     */
    public com.sable.database.collection.Collection get() throws SQLException {
        String query = toSQL();
        ...
        return new com.sable.database.collection.Collection(dbm.getConnection().query(query));
    }

    /**
     * Runs the {@link DatabaseManager#queryUpdate(QueryBuilder)} method with
    ...
    public int update(ChangeableClosure closure) throws SQLException {
        type = Database.QueryType.UPDATE;
    ...
    /**
     * Runs the {@link DatabaseManager#queryUpdate(QueryBuilder)}
    ...
    /**
     * Runs the {@link DatabaseManager#queryInsert(QueryBuilder)} method with
     * the current instance of the query builder, and the given items from the changeable closure.
     *
     * @param closure The changeable closure that should be run.
     ...
     *                      or the SQL statement returns a <code>ResultSet</code> object
     */
    public com.sable.database.collection.Collection insert(ChangeableClosure closure) throws SQLException {
        type = Database.QueryType.INSERT;
        ...
        return new com.sable.database.collection.Collection();
    }

    /**
     * Runs the {@link DatabaseManager#queryInsert(QueryBuilder) }
     * method with the current instance of the query builder.
     *
     ...
     *                      or the SQL statement returns a <code>ResultSet</code> object
     */
    public com.sable.database.collection.Collection insert(List<String>... arrays) throws SQLException {
     ...
     *                      or the SQL statement returns a <code>ResultSet</code> object
     */
    public com.sable.database.collection.Collection insert(Map<String, Object>... items) throws SQLException {
        type = Database.QueryType.INSERT;
    ...
    public int delete() throws SQLException {
        type = Database.QueryType.DELETE;
     ...
     *                      or the SQL statement returns a <code>ResultSet</code> object
     */
    private com.sable.database.collection.Collection runInsertQuery() throws SQLException {
