...
public class CheckPermissionUtil {
    ...
    /**
     * Checks if the sable can send embed messages in the given message channel.
     *
     * @param channel The message channel that should be checked.
     * @return <code>True</code> if the sable can send a message in it, <code>False</code> otherwise.
     */
     ...
     * what type of permissions the sable has for the current channel.
     */
    public enum PermissionCheckType {

        /**
         * Represents the sable having access to both
         * send, and embed send permissions.
         */
        EMBED(true, true),

        /**
         * Represents the sable having access to send messages,
         * but not to send embed message permissions.
         */
        MESSAGE(true, false),

        /**
         * Represents the sable not having access to send messages in any form.
         */
        NONE(false, false);
