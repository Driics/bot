...
public class AutoloaderUtil {
     ...
     * will be instantiated with the Sable instance passed to the
     ...
     * <p>
     * If the {@code parseAvaIreInstance} argument is set to true, the Sable
     ...
     * @param path                The package path that should be autoloaded.
     * @param callback            The consumer used to register the loaded class.
     * @param parseAvaIreInstance Determines if the Sable instance should be passed
