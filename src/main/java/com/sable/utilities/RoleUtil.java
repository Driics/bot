...
public class RoleUtil {
     ...
     * not higher in the role hierarchy then any role the user and the sable instance
     * for the current guild has, if the method returns true the sable should be
     ...
     * @return True if both the given user and sable can interact with the role, false otherwise.
     */
    ...
    /**
     * Checks if the sable can interact with the given role by making sure the role
     * is not higher in the role hierarchy than any role the sable has, if the
     * method returns true the sable has at least one role which is in a
     * higher position in the role hierarchy.
     *
     * @param message The JDA message instance for the current guild.
     * @param role    The role that the user should be able to interact with.
