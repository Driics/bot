...
import com.sable.servlet.routes.GetVote;
import com.sable.servlet.routes.PostVote;
...
public class VoteManager {
    ...
    /**
     * Creates the vote manager instance with the given Sable
     ...
     *
     * @param avaire The main Sable instance.
     */
    public VoteManager(Sable avaire) {
        this.avaire = avaire;
     ...
     * the sable, or when a user attempts to use a command that
